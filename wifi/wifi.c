...
// sockets is in
    ...
    #endif
    #ifndef WIFI_DRIVER_MODULE_ARG
    #define WIFI_DRIVER_MODULE_ARG         "firmware_path=/system/lib/modules/fw_bcm40181a2.bin nvram_path=/system/lib/modules/bcm40181_nvram.txt"
    #endif

#elif defined BCM40183_SDIO_WIFI_USED

    #ifndef WIFI_DRIVER_MODULE_PATH
    #define WIFI_DRIVER_MODULE_PATH         "/system/lib/modules/bcm40183_dhd.ko"
    #endif
    #ifndef WIFI_DRIVER_MODULE_NAME
    #define WIFI_DRIVER_MODULE_NAME         "dhd"
    #endif
    #ifndef WIFI_DRIVER_MODULE_ARG
    #define WIFI_DRIVER_MODULE_ARG         "firmware_path=/system/lib/modules/bcm40183_fw.bin nvram_path=/system/lib/modules/bcm40183_nvram.txt"
    #endif
